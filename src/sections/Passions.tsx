        ...
        <section id="passions" className="py-20 bg-gray-100">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <PassionItem icon="🎨" title="Anime" description="Imaginación sin límites en cada episodio, de quienes aprendi a nunca rendirme." images={["/images/anime1.jpg", "/images/anime2.jpg", "/images/anime3.jpg", "/images/anime4.jpg", "/images/anime5.jpg"]} />
