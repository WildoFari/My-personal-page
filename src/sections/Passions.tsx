        ...
        <section id="passions" className="py-20 bg-gray-100">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <PassionItem icon="🌍" title="Viajar" description="Nuevos paisajes, culturas y con el trail running" images={["/images/travel1.jpg", "/images/travel2.jpg", "/images/travel3.jpg", "/images/travel4.jpg"]} />
