...
export default function About() {
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-white px-6 md:px-12">
      ...
      <div className="flex justify-center">
        <div className="relative w-64 h-64">
          ...
          />
          <div className="absolute inset-0 rounded-full border-4 border-blue-600 dark:border-blue-400 animate-spin-slow"></div>
        </div>
      </div>
